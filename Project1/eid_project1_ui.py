...
# Form implementation generated from reading ui file 'eid_project1.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.setHumLimitButton.setGeometry(QtCore.QRect(170, 280, 141, 30))
        self.setHumLimitButton.setObjectName("setHumLimitButton")
        self.changeUnitsButton = QtWidgets.QPushButton(Dialog)
        self.changeUnitsButton.setGeometry(QtCore.QRect(370, 90, 99, 30))
        ...
        self.label_5.setGeometry(QtCore.QRect(400, 220, 121, 31))
        self.label_5.setObjectName("label_5")
        self.humLimitLine = QtWidgets.QLineEdit(Dialog)
        self.humLimitLine.setGeometry(QtCore.QRect(30, 280, 113, 32))
        self.humLimitLine.setClearButtonEnabled(False)
        self.humLimitLine.setObjectName("humLimitLine")
        self.getTempPlotButton = QtWidgets.QPushButton(Dialog)
        self.getTempPlotButton.setGeometry(QtCore.QRect(50, 160, 161, 31))
        self.getTempPlotButton.setObjectName("getTempPlotButton")
        self.getHumPlotButton = QtWidgets.QPushButton(Dialog)
        self.getHumPlotButton.setGeometry(QtCore.QRect(320, 160, 161, 31))
        self.getHumPlotButton.setObjectName("getHumPlotButton")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.getTempPlotButton.setText(_translate("Dialog", "Get Temperature Plot"))
        self.getHumPlotButton.setText(_translate("Dialog", "Get Humidity Plot"))
